...
# Fonksiyonlar - Tanımlayıcı istatistik fonksiyonu #
...
UserAllstats <- function(data) {
  ...
  sonuc[8,] <- apply(data, 2, PerformanceAnalytics::skewness)
  sonuc[9,] <- apply(data, 2, PerformanceAnalytics::kurtosis)
